class AppConfig {
  ...
  //   static const String geminiProxyUrl = 'https://ukhmymbgfzbpulwsfmrd.supabase.co/functions/v1/gemini-proxy';
  ...
  // Google OAuth Redirect URL (for web)
  static const String googleAuthRedirectUrl = 'https://igjihyuxiejeilxglpni.supabase.co/auth/v1/callback'; // Replace with your Production Google OAuth Redirect URL

  // Google Sign-In Web Client ID (for mobile)
  static const String googleSignInWebClientId = '998282656789-og31pr3bvcdi7b49p1emo5bsuc9s5t5m.apps.googleusercontent.com';
  static const String geminiProxyUrl = 'https://igjihyuxiejeilxglpni.supabase.co/functions/v1/gemini-proxy'; 
 }
