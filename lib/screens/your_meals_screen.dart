...
class _YourMealsScreenState extends State<YourMealsScreen> {
  ...
  IconData _getNutritionIcon(String nutritionKey) {
    return _nutritionRestrictionIcons[nutritionKey] ??
              ...
              children: [
                ...
                FutureBuilder<Map<String, dynamic>>(
                  ...
                  builder: (context, snapshot) {
                      ...
                      return Expanded(
                        child: Center(
                          child: Column(
                            ...
                            children: [
                              Image.asset(
                                'assets/images/upload_diet_chart.png',
                                width: 200,
                                height: 200,
                              ),
                              // const Text(
                              ...
                              Text(
                                "Upload your diet plan by clicking the 'Upload Diet' button below to import your personalized meal plan.",
                                textAlign: TextAlign.center,
                                style: TextStyle(
                                  fontSize: 14.0,
                                  color: Colors.black,
                    ...
                    final userMealPlan = UserMealPlan.fromMap(
                      data['userMealPlan'],
                    );
                    final meals = (data['meals'] as List)
                        .map((e) => Meal.fromMap(e))
                        .toList();
                    final mealItems = (data['mealItems'] as List)
                        .map((e) => MealItem.fromMap(e))
                        .toList();
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Icon(
                                                  ...
                                                  ), // Get icon based on nutrition key
                                                ...
                                                Text(
                                                  ...
                                                  style: Theme.of(context)
                                                      ...
                                                      ?.copyWith(
                                                        ...
                                                        color: Colors
                                                            .blue
                                                            .shade900, // Adjusted color for better contrast on gradients
                                                        fontSize:
                                                            12.0, // Set font size to 12
                                                      ),
                                                ),
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return Column(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(height: 8),
                                    for (var item in mealItems.where(
                                      ...
                                      Card(
                                        ...
                                        child: Container(
                                          decoration: BoxDecoration(
                                            gradient: LinearGradient(
                                              colors:
                                                  _gradientColors[(mealItems
                                                              .indexOf(item) +
                                                          2) %
                                                      _gradientColors
                                                          .length], // Use a different gradient for meal items
                                              begin: Alignment.topLeft,
                                              end: Alignment.bottomRight,
                                            ),
                                            borderRadius: BorderRadius.circular(
                                            ...
                                            children: [
                                              Row(
                                                children: [
                                                  Icon(
                                                    Icons
                                                        .restaurant_menu, // Generic food icon
                                                    color: Colors.blue.shade900,
                                                    size: 24,
                                                  ),
                                                    ...
                                                    child: Text(
                                                      ...
                                                      style: Theme.of(context)
                                                          ...
                                                          ?.copyWith(
                                                            ...
                                                            color: Colors
                                                                .blue
                                                                .shade900, // Adjusted color for better contrast
                                                          ),
                                                    ),
                                                  ),
                                                ],
          ...
          showDialog(
            ...
            builder: (BuildContext context) {
              ...
              AnalyticsService().logEvent(
                'diet_chart_upload_dialog_opened',
                {},
              );
